...
document.getElementById("sumOfArray").innerHTML = numbers.reduce((sum, num) => sum + num);

// Step 6: Use the map array method to multiple each element in the array variable by 2 and assign the result to the HTML element with an ID of "multiplied"
let multipliedNumbers = numbers.map(num => num * 2);

document.getElementById("multiplied").innerHTML = multipliedNumbers.join(", ")

// Step 7: Use the map and reduce array methods to sum the array elements after multiplying each element by two.  Assign the result to the HTML element with an ID of "sumOfMultiplied"

document.getElementById("sumOfMultiplied").innerHTML = multipliedNumbers.reduce((sum, num) => sum + num);